      ...
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            ...
            "[--sidebar-width:16rem] [--sidebar-width-icon:4rem]",
            className,
          )}
          {...props}
        >
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>Sidebar navigation and options.</SheetDescription>
          </SheetHeader>
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        "relative flex w-full min-w-0 flex-col py-2 px-1",
        className,
      )}
      {...props}
    />
