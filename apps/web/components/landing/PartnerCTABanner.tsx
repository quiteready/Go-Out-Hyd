  ...
  return (
    <section className="bg-[#0a0a0a] px-6 py-[100px]">
      <div className="mx-auto max-w-[620px]" data-reveal>
        ...
        <div className="mb-9 grid grid-cols-1 gap-6 min-[560px]:grid-cols-2">
          {PARTNER_CARDS.map((card) => (
            <div
              key={card.id}
              className="rounded-[10px] border border-white/[0.06] bg-[#141414] p-7 text-left"
            >
              ...
              <Link
                href={card.href}
                className="inline-flex min-h-[42px] items-center justify-center rounded-[6px] bg-yellow px-6 text-[13px] font-medium tracking-[0.02em] text-black shadow-[0_2px_12px_rgba(251,244,151,0.2)] transition-opacity hover:opacity-85"
              >
                {card.cta}
              </Link>
            </div>
        ...
        <p className="text-center text-[12px] font-light text-white/20">
