    ...
    <div>
      ...
      <section className="bg-background px-4 py-14 sm:px-6 sm:py-16">
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto h-9 w-64 animate-pulse rounded bg-foreground/8" />
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:gap-8">
            {[1, 2, 3, 4].map((i) => (
              ...
              >
                <div className="h-12 w-12 animate-pulse rounded-lg bg-foreground/8" />
                <div className="mt-4 h-6 w-3/4 animate-pulse rounded bg-foreground/8" />
                <div className="mt-2 h-4 w-full animate-pulse rounded bg-foreground/8" />
                <div className="mt-2 h-4 w-5/6 animate-pulse rounded bg-foreground/8" />
              </div>
            ))}
          </div>
        </div>
