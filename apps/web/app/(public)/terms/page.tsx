    ...
    <LegalLayout tocSidebar={<TableOfContents sections={tocSections} />}>
      ...
      >
        ...
        <section id="description">
          ...
          <p>
            The Service allows users to interact with these AI models through a
            single, consistent interface, with features including conversation
            history, model switching, and subscription-based access controls.
          </p>
          <p>
            We offer both free and paid subscription tiers with different usage
            limits and feature access. The availability of specific models and
        ...
        <section id="subscription">
          ...
          <p>
            ...
            your payment method for the subscription fee, applicable taxes, and
            any additional usage fees.
          </p>
